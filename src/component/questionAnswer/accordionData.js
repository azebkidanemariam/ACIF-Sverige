export const accordionData = [
  ...
  },
  {
    ...
    content: `Repentance is a profound act of acknowledging one's wrongdoings, accompanied by a sincere desire for change and a commitment to rectify past mistakes. It involves remorse for actions or decisions that have caused harm, whether to oneself or others. Central to many spiritual and moral traditions, repentance signifies an inner transformation, urging individuals to reflect on their behavior, take responsibility, and seek forgiveness. It's a process that demands humility, introspection, and the determination to make amends, leading to personal growth, reconciliation, and a renewed sense of integrity!`,
    verse: ` Acts 3:19 (New International Version) - "Repent, then, and turn to God, so that your sins may be wiped out, that times of refreshing may come from the Lord."`,
  },
  {
